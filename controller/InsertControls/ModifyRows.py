...
# Adding new rows
@modify_bp.route('/home/patient-options/addPatient', methods=['POST', 'GET'])
def newPatientRow():
    ...
    cursor.execute(GetTables.getPatientTable())
    patients = cursor.fetchall()
    cursor.execute(GetTables.getAllFamilyTable())
    family = cursor.fetchall()
    return render_template('patient.html', patients=patients, family=family)

@modify_bp.route('/home/patient-options/addFamily', methods=['POST', 'GET'])
def newFamilyRow():
    if(request.method == 'POST'):
        familyLastName = request.form['familyLastName']
        phoneNumber = request.form['phoneNumber']
        addFamilyRow(familyLastName, phoneNumber)
    cursor.execute(GetTables.getFamilyTable())
    family=cursor.fetchall()
    return render_template('family.html', family=family)
@modify_bp.route('/home/patient-options/addRoom', methods=['POST', 'GET'])
def newRoomRow():
    if(request.method == 'POST'):
        roomNumber = request.form['roomNumber']
        patientID = request.form['patientID']
        addRoomRow(roomNumber, patientID)
    cursor.execute(GetTables.getRoomTable())
    room = cursor.fetchall()
    cursor.execute(GetTables.getPatientTable())
    patient = cursor.fetchall()
    return render_template('room.html', room=room, patient=patient)

@modify_bp.route('/home/faculty-options/addFaculty', methods=['POST', 'GET'])
def newFacultyRow():
    if(request.method == 'POST'):
    ...
    cursor.execute(GetTables.getFacultyTable())
    faculty = cursor.fetchall()
    cursor.execute(GetTables.getFacultyTypeTable())
    facultyType = cursor.fetchall()
    return render_template('faculty.html', faculty=faculty, facultyType=facultyType)

@modify_bp.route('/home/faculty-options/addFacultyType', methods=['POST', 'GET']) 
...
@modify_bp.route('/home/faculty-options/addAssignment', methods=['POST', 'GET'])
def newAssignmentRow():
    ...
    cursor.execute(GetTables.getAssignTable())
...
@modify_bp.route('/home/medication-options/addMedication', methods=['POST', 'GET'])
...
@modify_bp.route('/home/medication-options/addPatientMedication', methods=['POST', 'GET'])
def newPatientMed():
    if(request.method == 'POST'):
        patient = request.form['patient']
        medication = request.form['medication']
        addPatientMedRow(patient, medication)
    cursor.execute(GetTables.getPatientMedTable())
...
@modify_bp.route('/home/patient-options/deletePatient/<int:id>', methods=['POST', 'GET']) # Possibly modify
...
@modify_bp.route('/home/patient-options/deleteFamily/<int:id>', methods=['POST', 'GET'])
def deleteFamily(id):
...
@modify_bp.route('/home/patient-options/deleteRoom/<int:id>', methods=['POST', 'GET'])
def deleteRoom(id):
    try:
...
@modify_bp.route('/home/faculty-options/deleteFaculty/<int:id>', methods=['POST', 'GET'])
...
@modify_bp.route('/home/faculty-options/deleteFacultyType/<int:id>', methods=['POST', 'GET'])
...
@modify_bp.route('/home/faculty-options/deleteAssignment/<int:id>', methods=['POST', 'GET']) 
def deleteAssign(id):
    try:
...
@modify_bp.route('/home/medication-options/deleteMedication/<int:id>', methods=['POST', 'GET']) 
...
@modify_bp.route('/home/medication-options/deletePatientMedication/<int:id>', methods=['POST', 'GET'])
